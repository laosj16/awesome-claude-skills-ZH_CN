...
- [ax-extract-workflow](https://github.com/Necmttn/ax/tree/main/skills/ax-extract-workflow) - 从本地 ax 会话、提交记录、技能调用和子 Agent 活动中，还原 PR、功能或报告等交付物的产出流程。*作者 [@Necmttn](https://github.com/Necmttn)*
